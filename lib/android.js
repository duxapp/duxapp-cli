...
module.exports = {
  ...
  async packageName(name) {
    ...
    const currentPath = currentName.split('.').join('/')
    ...
    const func2 = data => data.replace(`package ${currentName};`, `package ${name};`).replace(`import ${currentName}.generated.BasePackageList;`, `import ${name}.generated.BasePackageList;`)

...
module.exports = {
  create() {
    ...
    const androidFiles = [
      ...
      'android/app/src/debug/java/com/duxapp/ReactNativeFlipper.java',
      'android/app/src/release/java/com/duxapp/ReactNativeFlipper.java',
      'android/app/src/main/AndroidManifest.xml',
      'android/app/src/main/java/com/duxapp/MainActivity.java',
    ...
    // 新架构
    if (duxappConfig.android.fabricEnabled) {
      fileExec.replace('android/gradle.properties', 'fabricEnabled', 'true', duxappConfig, apps)
    }
    // 压缩开关
    ...
    // 新架构
    if (duxappConfig.ios.fabricEnabled) {
      fileExec.replace('ios/Podfile', 'fabricEnabled', 'true', duxappConfig, apps)
    }
    // hermes引擎

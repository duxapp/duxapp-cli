...
module.exports = {
  create() {
     ...
     * 复制文件
     */
    const rnFileList = ['android', 'ios', '.node-version', 'app.json', 'index.js', 'metro.config.js']
    rnFileList.forEach(name => {
      file.delete(name)
      file.copy('node_modules/duxapp-cli/projectTemplate/' + name, name)
    })
